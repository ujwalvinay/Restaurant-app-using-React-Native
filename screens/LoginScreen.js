     ...
     <StatusBar style="light"></StatusBar>
       ...
       />
        <View className="flex-row justify-center w-full absolute">
          <Animated.Image entering={FadeInUp.delay(200).duration(1000).springify()} className='h-[250] w-[250] pt-10' source={{uri:'https://ujwalvinay.com/project/bakery-logo.png'}}
          />
